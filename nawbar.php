...
<nav class="navbar position-fixed start-0 top-0 bottom-0 h-100" style="width: 120px; background-color: #fda087 !important; border-radius: 0 15px 15px 0; z-index: 1000;">
    <div class="container-fluid d-flex flex-column h-100 p-0">
        ...
        <div class="nav-bottom mb-3 text-center w-100">
            ...
            <a href="../visual/account.php" class="nav-link p-2" title="Cuenta">
             <img src="../img/casaa.png" alt="Cuenta" width="100" height="100"> 
