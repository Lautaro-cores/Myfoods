...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-09-2025 a las 13:40:05
...
ALTER TABLE `comentarios`
  ...
  ADD CONSTRAINT `fk_comentarios_usuarioid` FOREIGN KEY (`usuarioid`) REFERENCES `usuario` (`usuarioid`);
...
ALTER TABLE `likes`
  ...
  ADD CONSTRAINT `fk_likes_usuarioid` FOREIGN KEY (`usuarioid`) REFERENCES `usuario` (`usuarioid`);
...
--
ALTER TABLE `publicacion`
  ADD CONSTRAINT `fk_publicacion_usuarioid` FOREIGN KEY (`usuarioid`) REFERENCES `usuario` (`usuarioid`);
COMMIT;
